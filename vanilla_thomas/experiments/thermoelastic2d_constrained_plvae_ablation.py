...
@dataclass
class Args:
    """Command-line arguments for constrained Performance-LVAE training on thermoelastic2d."""
    ...
    """Weight for reconstruction loss. Set to 0.0 to disable reconstruction."""
    ...
    for epoch in range(args.n_epochs):
        ...
        for i, batch in enumerate(bar):
            ...
            if args.w_reconstruction == 0.0:
                loss = th.tensor(plvae.perf_loss, requires_grad=True)
            loss.backward()
            ...
            if args.track:
                ...
                if batches_done % args.sample_interval == 0:
                    with th.no_grad():
                        ...
                        p_predicted = p_scaler.inverse_transform(
                            p_pred_scaled.cpu().numpy()
                        ).flatten()
