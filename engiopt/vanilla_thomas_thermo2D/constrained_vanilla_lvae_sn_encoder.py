...
from engiopt.vanilla_lvae.components_sn_encoder import SNEncoder2D
...
class Args:
    ...
    """WandB run name override. If None, auto-generated from problem_id, algo, seed, timestamp."""
    seed: int = 1
...
if __name__ == "__main__":
    ...
    enc = SNEncoder2D(args.latent_dim, design_shape, args.resize_dimensions)
