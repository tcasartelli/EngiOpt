...
from aes_val_pruning import ConstrainedLeastVolumeAE_DP_ValPruning as ConstrainedLeastVolumeAE_DP
...
if __name__ == "__main__":
    ...
    # Set data variance for NMSE computation
    ...
    for epoch in range(args.n_epochs):
        ...
        with th.no_grad():
            ...
            lvae.train()
        lvae.epoch_report(epoch=epoch, callbacks=[], val_z=val_z, batch=None, loss=loss, pbar=None)
        if args.track:
            wandb.log({
                "epoch"       : epoch,
